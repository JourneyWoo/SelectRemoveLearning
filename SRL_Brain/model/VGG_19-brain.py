...
def cnn_model():
    ...
    for chc in range(3):
        ...
        # 3.3
        W_conv16 = weight_variable("w17.bin", chc_select, [3, 3, 16, 16])
        b_conv16 = bias_variable("b17.bin", chc_select, [16])
        ...
        # 4.3
        W_conv17 = weight_variable("w18.bin", chc_select, [3, 3, 32, 32])
        b_conv17 = bias_variable("b18.bin", chc_select, [32])
        ...
        # 5.3
        W_conv18 = weight_variable("w19.bin", chc_select, [3, 3, 32, 32])
        b_conv18 = bias_variable("b19.bin", chc_select, [32])
